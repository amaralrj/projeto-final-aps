				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="emailusr" name="emailusr" type="text"
							placeholder="Endereço de e-mail" class="input-xlarge" required="">
					</div>
				</div>
				<!-- Text input-->
				<div class="control-group">
					...
					<div class="controls">
						<input id="datanascimentousr" name="datanascimentousr" type="text"
							placeholder="Data de nascimento" class="input-xlarge" required="">
					</div>
				</div>
				<!-- Select Basic -->
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox"> <input type="checkbox"
							name="notificausr" value="Sim. Gostaria de receber notificações.">
							Sim. Gostaria de receber notificações.
						</label>
					</div>
				</div>
				<div class="control-group">
